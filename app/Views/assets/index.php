    ...
    <main>
        ...
        <section class="crud-card">
            ...
            <?php foreach ($assets as $asset): ?><tr>
                ...
                <td><span class="group-chip" data-chip="<?= esc($asset['asset_group']) ?>"><?= esc(ucwords(strtolower($asset['asset_group']))) ?></span></td><td><?= esc(ucwords(strtolower($asset['location']))) ?></td>
